...
<table border="0" width="100%">
	...
	<tr>
		...
		<td><a href="<?php echo BASE_URL; ?>cart/del/<?php echo $item['id']; ?>"><img src="<?php echo BASE_URL; ?>assets/images/deletar.png" width="15"></a></td>
	</tr>
	<?php endforeach; ?>
	<tr>
...
<form method="POST" action="<?php echo BASE_URL; ?>cart/payment_redirect" style="float:right">
	<select name="payment_type">
		...
		<option value="checkout_transparente">Mercado Pago Checkout Transparente</option>
