			...
			<div class="container">
				<div class="row">
					<div class="col-sm-2 logo">
						<a href="<?php echo BASE_URL; ?>"><img src="<?php echo BASE_URL; ?>assets/images/L_Diamond.png" /></a>
					</div>
					<div class="col-sm-7">
						<div class="head_help">(31) 98250-7014</div>
						<div class="head_email"><span>contato.diamondimportss@gmail.com</span></div>
	    ...
	    <footer>
	    		...
	    		<div class="row">
				  <div class="col-sm-4">
				  	<div class="widget">
			  			...
			  			<div class="widget_body">
			  				<?php $this->loadView('widget_item', array('list'=> $viewData['widget_featured2']));?>	</div>
			  		</div>
				  </div>
				  <div class="col-sm-4">
				  	<div class="widget">
				  ...
				  <div class="col-sm-4">
				  	<div class="widget">
			  			...
			  			<div class="widget_body">
			  				<?php $this->loadView('widget_item', array('list'=> $viewData['widget_toprated']));?>			  			</div>
			  		</div>
				  </div>
				</div>
	    	</div>
	    	...
	    	<div class="links">
	    		<div class="container">
	    			<div class="row">
						<div class="col-sm-4">
							<a href="<?php echo BASE_URL; ?>"><img width="150" src="<?php echo BASE_URL; ?>assets/images/L_Diamond.png" /></a><br/><br/>
							<strong>Apple | Xiaomi | Acessórios</strong><br/><br/>
	    	...
	    	<div class="copyright">
	    		<div class="container">
	    			<div class="row">
						<div class="col-sm-6">© <span>Diamond Imports</span> - <?php $this->lang->get('ALLRIGHTRESERVED'); ?>.</div>
						<div class="col-sm-6">
							<div class="payments">
