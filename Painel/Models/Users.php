<?php
	...
	public function add($name, $email, $password, $id_permission, $admin) {

		$sql = "INSERT INTO users (name, email, password, id_permission, admin) VALUES (:name, :email, :password, :id_permission, :admin)";
		$sql = $this->db->prepare($sql);
