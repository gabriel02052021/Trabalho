	...
	<form method="POST" enctype="multipart/form-data" action="<?php echo BASE_URL; ?>products/add_action"> 
		<div class="box">
			...
			<div class="box-body">
				...
				<div class="form-group <?php echo (in_array('id_brands', $errorItems))?'has-error':''; ?>">
				...
				<div class="form-group <?php echo (in_array('name', $errorItems))?'has-error':''; ?>">
					...
					<input required type="text" class="form-control" id="p_name" name="name" />
				</div>
